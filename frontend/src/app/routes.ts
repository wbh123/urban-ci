...
export const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'archive-management', name: 'console-archive-management', component: () => import('@/pages/console/ConsoleArchiveManagementPage.vue'), meta: { title: '小区与楼栋管理', inlineConsoleUser: true, allowedRoles: ['COMMUNITY_MANAGER', 'GOVERNMENT_MANAGER', 'ADMIN'] } },
      { path: 'spatial-archive', name: 'console-spatial-archive', component: () => import('@/pages/console/ConsoleSpatialArchivePage.vue'), meta: { title: '空间档案', inlineConsoleUser: true, allowedRoles: ['COMMUNITY_MANAGER', 'GOVERNMENT_MANAGER', 'ADMIN'] } },
      { path: 'review', name: 'console-review', component: () => import('@/pages/console/ConsoleReviewQueuePage.vue'), meta: { title: '专业复核队列', inlineConsoleUser: true, allowedRoles: ['EXPERT', 'PROFESSIONAL_REVIEWER', 'ADMIN'], requiredPermissions: ['inference:review'] } },
      ...
      { path: 'review/:inferenceId', name: 'console-review-detail', component: () => import('@/pages/console/ConsoleReviewDetailPage.vue'), meta: { title: '辅助分析结果复核', allowedRoles: ['EXPERT', 'PROFESSIONAL_REVIEWER', 'ADMIN'], requiredPermissions: ['inference:review'] } },
      { path: 'buildings/:buildingId', name: 'console-building-detail', component: () => import('@/pages/console/BuildingDetailPage.vue'), meta: { title: '楼栋统一档案', allowedRoles: ['EXPERT', 'PROFESSIONAL_REVIEWER', 'COMMUNITY_MANAGER', 'GOVERNMENT_MANAGER', 'ADMIN'] } },
      {
        path: 'buildings/:buildingId/assessment',
        name: 'console-building-assessment',
        redirect: (to) => ({
          name: 'console-building-detail',
          params: { buildingId: to.params.buildingId },
          query: { ...to.query, tab: 'risk' },
        }),
        meta: { title: '楼栋评分详情', allowedRoles: ['EXPERT', 'PROFESSIONAL_REVIEWER', 'COMMUNITY_MANAGER', 'GOVERNMENT_MANAGER', 'ADMIN'] },
      },
      { path: 'renewal-priorities', name: 'console-renewal-priorities', component: () => import('@/pages/console/ConsoleRiskReportsPage.vue'), meta: { title: '风险总览与楼栋报告', inlineConsoleUser: true, allowedRoles: ['GOVERNMENT_MANAGER', 'ADMIN'] } },
