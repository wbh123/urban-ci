...
export const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'archive-management', name: 'console-archive-management', component: () => import('@/pages/console/ConsoleArchiveManagementPage.vue'), meta: { title: '小区与楼栋管理', allowedRoles: ['COMMUNITY_MANAGER', 'GOVERNMENT_MANAGER', 'ADMIN'] } },
