...
public class AiInferenceProperties {
    ...
    /** PRECISION 精度优先档位独立读取超时，避免复用轻量短超时导致超时失败。 */
    private int precisionReadTimeoutMs = 90000;
    ...
    public int getPrecisionReadTimeoutMs() {
        return precisionReadTimeoutMs;
    }

    public void setPrecisionReadTimeoutMs(int precisionReadTimeoutMs) {
        this.precisionReadTimeoutMs = precisionReadTimeoutMs;
    }
