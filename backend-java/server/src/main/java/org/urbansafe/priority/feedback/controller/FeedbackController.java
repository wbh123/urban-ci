...
public class FeedbackController {
    ...
    public ResponseEntity<Map<String, Object>> uploadPublicImage(
            @PathVariable String reportCode, @RequestParam String trackingSecret, @RequestParam("file") MultipartFile file) {
    ...
    public ResponseEntity<Map<String, Object>> listPublicImages(
            @PathVariable String reportCode, @RequestParam String trackingSecret) {
    ...
    public ResponseEntity<byte[]> publicImageContent(
            @PathVariable String reportCode, @PathVariable UUID assetId, @RequestParam String trackingSecret) {
    ...
    public ResponseEntity<Map<String, Object>> list(
        ...
        return ResponseEntity.ok(success(managementQueryService.list(
                status, feedbackChannel, communityId, buildingId, keyword, submittedFrom, submittedTo, page, size)));
    }
    ...
    public ResponseEntity<Map<String, Object>> updateStatus(
            @PathVariable UUID reportId, @RequestBody Map<String, Object> body) {
    ...
    public ResponseEntity<Map<String, Object>> submitRectification(
        ...
        return ResponseEntity.ok(success(closureService.submitRectification(
                reportId, text(body.get("handlingSummary")), text(body.get("message")), CurrentUser.getUserId())));
    }
    ...
    public ResponseEntity<Map<String, Object>> completeReinspection(
        ...
        return ResponseEntity.ok(success(closureService.completeReinspection(
                reportId, passed, text(body.get("summary")), CurrentUser.getUserId())));
    }
