...
const props = withDefaults(defineProps<{ summary: BuildingSummaryView; compact?: boolean }>(), {
  compact: false,
})
...
<template>
  <el-card shadow="never" class="building-summary-card" :class="{ 'is-compact': compact }">
    <template #header>
    ...
    <dl v-if="!compact" class="summary-grid">
