...
export const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'buildings/:buildingId', name: 'console-building-detail', component: () => import('@/pages/console/ConsoleBuildingDetailPage.vue'), meta: { title: '楼栋统一详情', allowedRoles: ['EXPERT', 'PROFESSIONAL_REVIEWER', 'COMMUNITY_MANAGER', 'GOVERNMENT_MANAGER', 'ADMIN'] } },
      { path: 'buildings/:buildingId/assessment', name: 'console-building-assessment', redirect: (to) => ({ name: 'console-building-detail', params: { buildingId: to.params.buildingId }, query: { tab: 'assessment' } }), meta: { title: '楼栋评分详情', allowedRoles: ['EXPERT', 'PROFESSIONAL_REVIEWER', 'COMMUNITY_MANAGER', 'GOVERNMENT_MANAGER', 'ADMIN'] } },
