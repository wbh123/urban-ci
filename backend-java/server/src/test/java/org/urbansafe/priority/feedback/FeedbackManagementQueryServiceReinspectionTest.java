...
class FeedbackManagementQueryServiceReinspectionTest {
    ...
    @Test
    void managementListExcludesRecordedTasksAndReturnsLatestHumanDecision() {
        ...
        assertThat(sql.getValue())
                ...
                .contains("reinspectionDecision")
                .contains("recommendedDecision")
                .contains("decisionReason")
                .contains("RECTIFICATION_CLOSED_WITHOUT_REINSPECTION")
                .contains("REINSPECTION_WAIVED");
    }
}
